...
package_name = 'py_trees_ros_behaviors'
...
setup(
    ...
    data_files=[
        ...
        ('share/ament_index/resource_index/packages', [
            'resources/py_trees_ros_behaviors']),
    ] + gather_launch_files(),
    package_data={'py_trees_ros_behaviors': ['mock/gui/*']},
    install_requires=[],  # it's all lies (c.f. package.xml, but no use case for this yet)
    extras_require={},
    author='Daniel Stonier',
    maintainer='Daniel Stonier <d.stonier@gmail.com>',
    url='https://github.com/Gastd/py_trees_ros_behaviors',
    ...
    entry_points={
        'console_scripts': [
            # Mocks
            'mock-battery = py_trees_ros_behaviors.mock.battery:main',
            'mock-dashboard = py_trees_ros_behaviors.mock.dashboard:main',
            ...
            # Mock Tests
            'mock-dock-client = py_trees_ros_behaviors.mock.actions:dock_client',
            'mock-move-base-client = py_trees_ros_behaviors.mock.actions:move_base_client',
            'mock-rotate-client = py_trees_ros_behaviors.mock.actions:rotate_client',
            # Tutorial Nodes
            'tree-data-gathering = py_trees_ros_behaviors.one_data_gathering:tutorial_main',
